...
import { itemVariants } from '../variants/index.ts';
        ...
        {quantity === 0 ? (
          ...
          >
            <img
              ...
              className="size-5"
            />
            <span className="preset-4-bold inline-block text-rose-900 group-hover:text-red group-focus-visible:text-red">
              Add to Cart
            </span>
          </motion.button>
        ) : (
          <div className="m-[-22px] flex w-40 items-center justify-between gap-2 rounded-full border border-red bg-red p-3">
